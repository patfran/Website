<div id="side-nav" class="col-md-4">
	<ul class="nav nav-pills nav-stacked" data-spy="affix">
		...
		<li role="presentation"><a href="https://github.com/ppf3" target="_blank">GITHUB <span class="fa fa-external-link"></span></a></li>
		<li role="presentation"><a href="mailto:ppf3@njit.edu">EMAIL <span class="fa fa-paper-plane-o"></span> </a></li>
	</ul>
</div>