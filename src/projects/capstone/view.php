    ...
    <div id="highlighted" class="clearfix">
        ...
        <div class="tabs" > 
            <ul class="nav nav-tabs" style="width:100%; margin: auto; padding: 0; float: right;">
                ...
                <li class="active"><a href="view.php" class="viewtab" title="View your current assignment">    &nbsp View &nbsp<span class="element-invisible">(active tab)</span></a></li>
...
<!------------------------------------------------------------->
    ...
    <div id="tabs-nohdr">
        <ul>
            <li><a href="#tab-overall">Assignment Details</a></li>
            <li><a href="#tab-create">"Create" Parameters</a></li>
            <li><a href="#tab-edit">"Edit" Parameters</a></li>
            <li><a href="#tab-solve">"Solution" Parameters</a></li>
            <li><a href="#tab-grading">"Grading" Parameters</a></li>
        </ul>
        ...
        <div id="tab-create">
            ...
            <b>Task Details</b> <br>
            <?php echo $_SESSION['C_instructions'] ?> <br><br>

            <b>Task Duration</b> <br> 
		...
		<br>
    <p><i>(full string for testing purposes)</i></p>
   --> <?php echo $assignment->asXML(); ?>
