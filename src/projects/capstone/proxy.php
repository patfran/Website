...
<?php
/*
echo "connection before!";


$con = mysqli_connect("sql2.njit.edu","ppf3","0qzdkDbiE","ppf3");
...
if (mysqli_connect_errno())
    {
      ...
      echo "connection after!";



mysqli_query($con,"INSERT INTO SavedStrings (XMLString) 
    VALUES (echo $assignment->asXML();) ");

echo "did this actually write anything?";

mysqli_close($con);

header('Location: vform1.php');
