...
<form action="form1.php" method="post" id="flow-info">
    <fieldset>
        <p>
	        ...
	        <input required type="text" name="assignment_name" id="assignment_name" class="round full-width-input"/>
	        <em>Enter the title of this assignment.</em>	
        </p>	
        <br><br>
        <p>
	        <label for="assignment_description">Assignment Description: (Optional)</label>
	        <textarea name="assignment_description" id="assignment_description" rows="4" cols="50"></textarea>
	        <em>Enter a description for this assignment.</em>	
        </p>										
        <br><br>
        <p>
	        <label for="number_of_questions">Number of Questions:</label>
	        <input required type="text" size="2" name="number_of_questions" id="number_of_questions"  value="1" onkeypress="return isNumberKey(event)"/>
	        <em>Enter the total number of questions that this assignment will contain.</em>	
        </p>									
        <br><br>									
        <p>
	        <label for="group_size">Group Size:</label>
	        <input required type="text" size="2" name="group_size" id="group_size" value="1" onkeypress="return isNumberKey(event)" />
	        <em>Enter how many students there will be per group (Enter 1 if no groups).</em>
        </p>									
